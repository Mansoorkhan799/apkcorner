...
export const metadata: Metadata = buildSiteMetadata(
  "Who We Are",
  "Meet the team behind Teen Patti APKs and learn how we research, write, and update our guides for Pakistani players.",
  "/who-we-are"
);
...
export default function WhoWeArePage() {
  return (
    <LegalPage
      title="Who We Are"
      description="The people and principles behind teenpattiapks.com.pk."
    >
      <p>
        We are a small editorial team based in Pakistan, passionate about mobile
        gaming and helping everyday users navigate the world of Teen Patti and
        earning applications with confidence.
      </p>
      <h2 className="text-xl font-semibold text-zinc-900">Our Editorial Approach</h2>
      <p>
        Every guide on Teen Patti APKs follows a structured process: we identify
      ...
      <h2 className="text-xl font-semibold text-zinc-900">Independence</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-zinc-900">For Our Readers</h2>
      <p>
        Whether you are downloading your first Teen Patti APK or looking for the
