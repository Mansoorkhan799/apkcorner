...
export const metadata: Metadata = buildSiteMetadata(
  "Disclaimer",
  "Legal disclaimer for Teen Patti APKs. Important information about our content, earnings claims, and third-party apps.",
  "/disclaimer"
);
...
export default function DisclaimerPage() {
  return (
    ...
    >
      <p>
        The information on <strong>teenpattiapks.com.pk</strong> is provided for
      ...
      <h2 className="text-xl font-semibold text-zinc-900">No Earnings Guarantee</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-zinc-900">Third-Party Apps</h2>
      <p>
      ...
      <p>
        To the fullest extent permitted by law, Teen Patti APKs and its authors
      ...
      <p>
        See also our{" "}
        <a href="/responsible-gaming" className="text-emerald-600 hover:underline">
          Responsible Gaming
        </a>{" "}
        policy.
      </p>
