...
export const metadata: Metadata = buildSiteMetadata(
  "Responsible Gaming",
  "Our responsible gaming policy for APK Corner readers. Play safely, set limits, and know when to stop.",
  "/responsible-gaming"
);
...
export default function ResponsibleGamingPage() {
  return (
    ...
    >
      <p>
        APK Corner is an informational website. We encourage all readers
      ...
      <h2 className="text-xl font-semibold text-foreground">Play Within Your Means</h2>
      ...
      <h2 className="text-xl font-semibold text-foreground">Warning Signs</h2>
      ...
      <h2 className="text-xl font-semibold text-foreground">Our Role</h2>
      <p>
